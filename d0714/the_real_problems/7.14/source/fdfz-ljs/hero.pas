...
const n=300+10;
var a:array[0..n,0..n]of longint;
    i:array[0..n]of longint;
...
begin
    ...
    for b2:=mm-2 downto 1 do for b3:=mm downto b2+2 do a[b2,b3]:=min(a[b2+1,b3]+kk,a[b2,b3]);
    for b2:=mm-1 downto 1 do for b3:=mm-1 downto b2+1 do a[b2,b3]:=min(a[b2,b3+1]+kk,a[b2,b3]);
