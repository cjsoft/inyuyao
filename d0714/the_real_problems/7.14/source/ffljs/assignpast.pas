...
{function ggans(f1,f2:longint):double;
var f3,f4,f5:longint;
    ans:double;
begin
	h1[0]:=1;
	for f3:=1 to nn do begin
	    if (f1 and (1 shl(f3+1)))=0 then begin
		if r[f3]-f2+1<0 then exit(0);
		h1[f3]:=h1[f3-1]*(r[f3]-f2+1)/(l[f3]-r[f3]+1);
	    end else begin
		if f2-1-l[f3]+1-
		h1[f3]:=h1[f3]*(f2-1-l[f3]+1)/(l[f3]-r[f3]+1)
